...
plt.plot([s1,s1], [0.00001, 0], '-', color='k')
plt.text(s1, 0.0000105, "$v_k$", fontsize=15, horizontalalignment='center')
plt.text(s2, 0.0000105, "$v_{k+1}$", fontsize=15, horizontalalignment='center')
plt.text(smid, 0.000001, "$v^\prime_k$", fontsize=15, horizontalalignment='center')
plt.plot([smid,smid], [0.00001, 0], ':', color=gray)
