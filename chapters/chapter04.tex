...
reduces the prediction error by decreasing the variance term in this decomposition. In
Section~\ref{sec:4:ensemble}, we study Random Forests ant its variants, which
all introduce even more randomness into the decision tree induction algorithm
