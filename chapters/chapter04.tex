...
correct decision, then adding more voters increases the probability that the
majority decision is correct. When $M \to \infty$, the probability that the decision
