...
Accordingly, theorems~\ref{thm:bias-variance} and \ref{thm:bias-
variance:classification} naturally extend to the expected generalization error
...
their respective counterparts computed over the joint distribution of ${\cal
L}$ and $\theta$.
