...
squared error with respect to the individual predictions of the models.
...
\end{align}
The first term is the average generalization of the individual models. The second term is the ensemble ambiguity and
...
the generalization error is therefore smaller than the average generalization
...
the average zero-one error with respect to the individual predictions of the models.
