...
The effect of ensemble methods on variance, on the other hand, is more
interesting. Let us first derive the correlation coefficient $\rho$ between the
predictions of two randomized models built on the same learning set ${\cal L}$
but grown from two independent random seeds $\theta_i$ and $\theta_j$:

% !!!! improvements in prediction are solely a  result of variance reduction
