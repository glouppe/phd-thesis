...
generalization error of a Random Forest~\citep{breiman:2001} (RF) and of Extremely
Randomized Trees~\citep{geurts:2006} (ETs), as estimated from Theorem~\ref{thm:bias-variance:ensemble}
...
bias, for which averaging is not able to compensate. For RF, the
optimal trade-off is at $K=8$. For ETs, the
