...
\item \citet{breiman:2004}:\hfill\\
    ...
    Additionally, this works studies the bias-variance decomposition of this simplified
...
\item \citet{biau:2012}:\hfill \\
    ...
    also highlights the fact that performance of random forests only depend on
