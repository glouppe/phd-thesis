...
\section{Ensembles of randomized models}
...
another. (We defer the discussion on specific random perturbations to
...
as random variables. Without loss of generality, we here assume that the random
variable $\theta$ only controls the randomness of the learning algorithm.
