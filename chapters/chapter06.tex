...
\text{Imp}(X_j) = \frac{1}{M} \sum_{m=1}^M \sum_{\substack{t \in \varphi_{m}\\v(s_t) = X_j}} p(t) \Delta i(s_t, t),
\end{equation}
...
the out-of-bag samples For that reason, this latter measure is also known as
the \textit{permutation importance}.
