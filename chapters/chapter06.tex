...
tree will have exactly $2^{p}$ leaves. As a result, totally randomized
trees, as considered here, are in fact closer to trees grown with ID3~\citep{quinlan:1986}
than trees built from the CART procedure (as described throughout Chapters~\ref{ch:cart} and \ref{ch:forest}).
