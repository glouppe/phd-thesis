...
however, standard approaches start showing their limits. For example, identifying the
genetic risk factors for heart disease, where knowledge is still
...
question each and every part of the random forests methodology,  both from a theoretical and
practical point of view. Accordingly, this work aims at revisiting decision
trees and random forests to hopefully shed new light on their learning
capabilities, inner workings and interpretability.
...
\item \citep{sutera:2014} \textit{Simple and robust inference of connectomes using partial correlation coefficients}, Antonio Sutera, Arnaud Joly, Vincent Francois et al., 2014.
