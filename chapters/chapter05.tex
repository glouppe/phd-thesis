...
interfaces presented above and supporting most of the hyper-parameters described
in this work.
...
\item \texttt{BaggingClassifier}, \texttt{BaggingRegressor}: \hfill \\
    ...
    and Ensembles of Random Patches~\citep{louppe:2012}.

\item \texttt{RandomForestClassifier}, \texttt{RandomForestRegressor}: \hfill \\
    Implement Random Forest~\citep{breiman:2001}.

\item \texttt{ExtraTreesClassifier}, \texttt{ExtraTreesRegressor}: \hfill \\
    Implement Extremely Randomized Trees~\citep{geurts:2006}.
\end{description}
