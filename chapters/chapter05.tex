...
representation of the toy decision tree shown in Figure~\ref{fig:5:tree}.

% todo: fix table numberings
% todo: add L
...
\begin{table}
    ...
    \hline
    \end{tabular}
    \caption{Array representation of Figure~\ref{fig:5:tree}.}
    \label{table:tree-array}
\end{table}



% avantage en terms de overhead et de prefetching
