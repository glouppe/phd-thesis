...
\begin{table}
    ...
    \hline
    \end{tabular}
    \captionof{table}{Time complexity for building forests of randomized trees. $\widetilde{N} = 0.632 N$, due to the fact that bootstrap samples draw, on average, $63.2\%$ of unique samples.}
