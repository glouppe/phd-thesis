...
array is not strictly necessary, since these values are only used during the
construction of the tree. Yet, storing them can prove to be valuable, e.g., for
later inspection of tree or for computing variable importances (see
