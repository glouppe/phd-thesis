...
like TMVA or Orange, include more advanced alternatives like gain ratio or
implement feature selection using the Relief algorithm~\citep{kira:1992}. The
most common stopping criteria are an upper bound on the depth of the trees
(e.g., \texttt{max\_depth} in Scikit-Learn) and a minimum number of
