...
\caption{Effect of the number $M$ of trees.}
...
\caption{Effect of the size $N$ of the learning set.}
...
\caption{Effect of the number $p$ of input variables.}
...
while the average depth of the leaves is constant with $M$, since the later has no
...
trees in the forest, which confirms our previous results on variance reduction from
...
those presented above. They all corroborate the theoretical results
presented earlier.
