...
trees, from the root to one of the leaves. As such, complexity is directly
...
once again as as in the best case.

\begin{remark}{Distribution of decision trees}
\todo{}
\end{remark}
