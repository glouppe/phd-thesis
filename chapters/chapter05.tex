...
\item \textit{Split approximations.}\hfill\\
    ...
    randomization is not necessarily damaging as long as it decorrelates the
    ...
    imperative in the first place to achieve good accuracy in forests. As proved by the
    ...
    (sometimes even better) performance. However, not only this yields
    ...
    The two most strategies are based on subsampling and binning:
