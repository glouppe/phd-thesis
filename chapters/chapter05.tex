...
like TMVA or Orange, include alternative measures such as the entropy, the gain
...
is reached. Despite the embarassing parallelism, only Scikit-Learn, Weka and
