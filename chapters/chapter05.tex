...
trees, from the root to one of the leaves. As a result, complexity is directly
...
a learning set ${\cal L}$ of size $N$.
...
\end{cases}
\end{equation}
For this equation, the second case of the Master Theorem applies for $a=1$, $b=2$ and $k=0$.
