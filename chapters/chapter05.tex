...
All implement the original Random Forest algorithm~\citep{breiman:2001}
...
\begin{table}
    ...
    \centering
    \rotatebox{90}{
    \begin{tabular}{| c | p{1.5cm} >{\centering}p{0.8cm} p{1.4cm} p{2.5cm} >{\centering}p{1.8cm} >{\centering}p{0.8cm} >{\centering}p{0.8cm} >{\centering}p{1.3cm} p{3.5cm} |}
    \hline
