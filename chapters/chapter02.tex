...
perfect. At the same time, the test estimates become worse because these
structures are too specific to the training set and do not generalize. The
model is overfitting. The best possible parameter values $\theta$ is therefore
the one making the appropriate trade-off between a resulting model which
...
\begin{figure}
    ...
    \caption{Training and test sample estimates with respect to the complexity
             ...
             $Err$ and the thick red curve is the expected training sample estimate $\mathbb{E}_{\cal
