...
L}(\varphi)$. The authors point out that most estimates, including $K$-fold
...
set error of $\varphi$ and thereby evaluate the actual effectiveness of
$\varphi$ with respect to the best model one can possibly build.
