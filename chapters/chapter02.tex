...
proceed with a discussion on performance evulation and then describe, in
...
this phenomenon can also be explained by decomposing the generalization error
...
to make the approriate \textit{bias-variance trade-off}.
