...
% si ls, plusieurs solutions possibles => maximiser la marge (hard margins)
% si pas ls => soft margins

% \citep{boser:1992}   => svm (hard margins)
% \citep{cortes:1995}  => svm (soft margins)

% extension à un kernel => trouver un hyperplan dans un espace de + haute dimension

\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/ch2_hyperplane.pdf}
    \caption{Best separating hyperplane.}
