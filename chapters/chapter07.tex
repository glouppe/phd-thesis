...
\item \textit{Feature selection.} \hfill \\
    ...
    predictors, mixed with both numerical and categorical variables and involving
    ...
    \item In some other applications, the objective is to identify variables
          ...
          relevant since their importances might appear as lower as the
          importance of noisy or irrelevant variables. Yet, several options
          ...
          of original input variables to artificial contrasts~\citep{tuv:2006}
    ...
    % citep{van:2008}
    % combination avec rfe guyon:2002, tuv:2009


    % choix du seuil => statistical tests (van anh, contrasts)
    %\citep{guyon:2003}
    %\citep{liu:2005}
    %\citep{tuv:2009}
