...
of variable importance measures. \textit{Caution: The work presented in
this chapter is exploratory. Conlusions should be considered with care, until
...
I(X_i;X_j) &= H(X_i) - H(X_i|X_j) \nonumber \\
           &= H(X_j) - H(X_j|X_i),
\end{align}
which implies that $H(X_i) = H(X_j)$ since $H(X_i|X_j) = H(X_j|X_i) = 0$ if  $X_i$ and $X_j$ are totally redundant.
Using the same argument, this directly extends
...
\subsection{Bias due to misestimations}
