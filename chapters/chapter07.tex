...
relevant variable, its importance is expected to be strictly positive and at
least as large as the importances of the irrelevant variables. For
$\text{relevance}=0.1$, the importance $X_2$ appears just slightly larger than
the importances of the other variables when $\texttt{max\_depth} \leq 3$. For
...
increases, $X_2$ is correctly identified as a relevant variable. In particular,
the more relevant $X_2$, that is the stronger the signal, the deeper trees can
be built until the importance of $X_2$ is made unrecognizable from the
irrelevant variables.

In conclusion, MDI importances...
