...
criteria to evaluate their respective goodness, the last thing which is missing to have
fully specified the induction procedure is an efficient optimization procedure
for finding the best split $s^* \in {\cal Q}$.

% on se limite à du binaire
% décomposition variable-wise
