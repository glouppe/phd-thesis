...
our specification of the tree induction procedure.
...
\begin{figure}[h]
    ...
    statistics of the previous split at $v^\prime_{k-1}$  and compared to the best reduction in impurity $\Delta$ found so far within the splits at $v^\prime_{0}=-\infty$ to $v^\prime_{k-1}$.}
