...
From this geometrical point of view, the principle of tree structured models is
...
guess value $\widehat{y}_t \in {\cal Y}$ of the output variable.
In classification, the terminal nodes hence form a partition (as defined by
...
terminal nodes $t$ such that $\widehat{y}_t = c_k$.

As an example, Figure~\ref{fig:3:tree} illustrates...
