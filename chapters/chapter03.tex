...
criterion~\ref{eqn:impurity:error} as two serious defects:
\begin{enumerate}
\item As a corollary of Proposition~\ref{prop:any-split-reduce-classification},
      ...
      $\Delta i(s, t_0) = 0$ for all three possible splits, as if splitting
      would not help capture some structure in the problem.
