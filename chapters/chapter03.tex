...
guided by ensuring that $\Delta i(s,t)$ gets larger when the child nodes are
more homogeneous in terms of class probabilities (while not being necessarily
better in terms of misclassification error) and null only in rare
circumstances, e.g., when the a priorio and a posteriori class distributions
