...
L}_t}|-1$ partitions of ${\cal L}_t$ into two such non-empty subsets, i.e.,
...
$v^\prime_k=\tfrac{v_k+v_{k+1}}{2}$ between consecutive values of the variable, as shown by the dotted line in Figure~\ref{fig:3:split-ordered}.
