...
${\cal X}$ with axis-parallel hyperplanes, as previously illustrated on Figure~\ref{fig:3:partition}.
...
surfaces or decision trees inside decision trees. Finally, in a slightly
different direction, \citet{olaru:2003} propose in soft decision trees to
redefine the notion of split as overlapping fuzzy sets (instead of disjoint
subsets), hence allowing samples close to the decision threshold $v$ to
propagate into both child nodes.
