...
More specifically, the induction algorithm usually assumes that $s^*$ --
...
\end{align}
In this framework, Line~\ref{algo:induction:split} of Algorithm~\ref{algo:induction}
therefore simply reduces to the implementation of Equation~\ref{eqn:best-split-single}.
...
resulting into smaller, yet as accurate, decision trees. In this framework
however, decomposition~\ref{eqn:best-best-split} no longer holds, hence making
the search of the best split often more computationally intensive.
