...
and further illustrated in Figure~\ref{fig:3:split:invariant}.

\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/ch3_split_ordered_invariant.pdf}
    \caption{Loop invariant of Algorithm~\ref{algo:findsplit:x_j}.}
...
complexity of the induction procedure.
