...
${\cal L}$, and then recursively partitioning into smaller subsets the subsets
of ${\cal L}$ represented by the nodes.  The learning procedure then revolves
...
Following the framework of \citet{breiman:1984}, the decrease of impurity
...
Algorithm~\ref{algo:induction}) according to some goodness criterion, such as those
finally described in Section~\ref{sec:3:criteria}.
