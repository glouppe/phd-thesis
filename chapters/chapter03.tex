...
\begin{figure}
\centering
\includegraphics[scale=0.75]{figures/ch3_toy_x1_gini.pdf}\\
\vspace{1cm}
\includegraphics[scale=0.75]{figures/ch3_toy_x1_error.pdf}
\caption{Splitting $t_0$ on $X_1$, as evaluated by a strictly concave impurity function (above) and by the resubtitution estimate (below).}
\label{fig:3:toy:impurity:x1}
\end{figure}
