...
hyper-parameters that have to be tuned in order to find the right trade-off.
Ideally, these parameters need to be such that they are nor too strict nor too
loose for the tree to be nor too shallow nor too deep. As described in
Section~\ref{sec:2:model-selection}, chosing the appropriate parameter values
is usually performed using a dedicated model selection procedure, which can be
computationally expensive, yet usually imperative for reaching good
