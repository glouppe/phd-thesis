...
% une hypothèse est de considérer le plus simple d'entre eux, pour espérer une bonne généralisation mais aussi une meilleure interprétabilité
% on pourrait chercher cet arbre en brute force, mais l'espace des arbres est large (quoique fini)
% => approche greedy pour limiter le nombre de computations
