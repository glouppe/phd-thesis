...
strategy consists in lookahead search, which consists in evaluating the
goodness of a split and of those deeper in the tree up to some fixed depth. As empirically
