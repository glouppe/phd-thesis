...
the exhaustive evaluation of all of these splits can be carried out efficiently when
...
\Function{FindBestSplit}{${\cal L}_t$, $X_j$}
    ...
    \State Sort the node samples ${\cal L}_t$ along variable $X_j$
    \State $i \gets 1$
    \While{$i \leq N_t$}
        ...
        \If{$i \leq N_t$}
            ...
            \If{$\Delta i(s^{v^\prime_{k+1}}_j, t) > \Delta$}
                \State $\Delta \gets \Delta i(s^{v^\prime_{k+1}}_j, t)$
