...
of criterion~\ref{eqn:impurity:error}, the choice of $i(t)$ should therefore be
...
on $0 \leq p_k \leq 1$, for $k=1,\dots,J$ and $\sum_{k=1}^J p_k = 1$ and such that
\begin{itemize}
...
\begin{align*}
p_L p(c_k|t_L) + p_R p(c_k|t_R) &= \frac{N_{t_L}}{N_t} \frac{N_{kt_L}}{N_{t_L}} +  \frac{N_{t_R}}{N_t} \frac{N_{kt_R}}{N_{t_R}} \\
                                &= \frac{N_{kt_L} + N_{kt_R}}{N_t} \\
                                &= \frac{N_kt}{N_t} \\
                                &= p(c_k|t)
\end{align*}
...
To better understand Theorem~\ref{thm:reduction-impurity}, let us come back to
our toy problem and let us consider the impurity measure $i(t)$ illustrated on
Figure~\ref{xxx} for which the requirements are satisfied.

\begin{figure}
\begin{minipage}[t]{0.48\textwidth}
\includegraphics[width=\linewidth]{figures/ch3_toy_x1_gini.pdf}
\end{minipage}
\hspace{\fill}
\begin{minipage}[t]{0.48\textwidth}
\includegraphics[width=\linewidth]{figures/ch3_toy_x1_error.pdf}
\end{minipage}

\vspace*{0.5cm} % (or whatever vertical separation you prefer)
\begin{minipage}[t]{0.48\textwidth}
\includegraphics[width=\linewidth]{figures/ch3_toy_x2_gini.pdf}
\end{minipage}
\hspace{\fill}
\begin{minipage}[t]{0.48\textwidth}
\includegraphics[width=\linewidth]{figures/ch3_toy_x3_gini.pdf}
\end{minipage}
...
% \begin{definition}
% An impurity function $i(t)$ is a function ...
%  evaluating the class distribution within node $t$.
% It is defined
% \begin{itemize}
% \item $i(t)$ is maximum only when $p(c_1|t)=\dots=p(c_J|t)$;
% \item $i(t)$ is minimum if it exists $j \in \{ 1,\dots,J \}$ such that $p(c_j|t)=1$;
% \item $i(t)$ is symmetric with respect to the classes $c_1, \dots, c_J$.
% \end{itemize}
%\end{definition}
