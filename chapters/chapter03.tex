...
partition procedure, regardless of overfitting. Node $t$ is necessarily set as
a terminal node in the following cases:
...
{\cal L}_t$ and for each input variable $X_j$. In this case, then ${\cal L}_t$
