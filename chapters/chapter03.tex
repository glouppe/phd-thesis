...
\end{equation}
With this criterion, picking the best split would therefore amount to pick the split that most
...
\item It does not account for the structure which is learned with respect to
      ...
      For instance, splitting on $X_1$ induces a posteriori class distributions
      ...
      posteriori class distributions that splitting on $X_1$ is likely to yield a
