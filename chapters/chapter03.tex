...
(Line~\ref{algo:induction:split} of Algorithm~\ref{algo:induction}) according
to some goodness or impurity criterion $i(t)$, such as those finally described
in Section~\ref{sec:3:criteria}. As we will see, assigning values to terminal
