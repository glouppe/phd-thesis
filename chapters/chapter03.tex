...
formally described in Algorithm~\ref{algo:induction}. Note that for the sake of
clarity, Definition~\ref{def:impurity-decrease} and
Algorithm~\ref{algo:induction} are formulated in terms of binary splits.
However, as we will explore later in Section~\ref{sec:3:splitting-rules}, they
generalize naturally to $n$-ary splits.
